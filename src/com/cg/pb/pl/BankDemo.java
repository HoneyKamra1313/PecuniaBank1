		...
		while (true) {
			...
			case 2:
				...
				case 1:
					...
					tsi.creditUsingSlip(actNo,amount);
					break;
				case 2:
					System.out.println("enter account number..");
					double actNo2 = scr.nextDouble();
					System.out.println("enter amount to deposite");
					int amount2 = scr.nextInt();

					tsi.debitUsingSlip(actNo2,amount2);
					break;
				case 3:
					System.out.println("enter account number..");
...
//				LocalDate strtDate = LocalDate.parse(startDate);
//				System.out.println("Enter End Date");
//				String enddate=scr.next();
//				LocalDate endDate = LocalDate.parse(enddate);
//				psi.accountSummary(accNo, strtDate, endDate);
				psi.getAllTransactions(accNo);
				break;
			}
		}
	}
